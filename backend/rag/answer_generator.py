...
из соседних упоминаний. Запрещены выдуманные диапазоны «с … по …»:
если есть только упоминание в роли от <дата> — формулируй
«командир не позднее <дата>» со ссылкой на пост."""
